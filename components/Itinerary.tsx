...
const events = [
  ...
  },
  {
    ...
    description: "Mingle with family & friends over hand-crafted cocktails in the garden terrace.",
    icon: Wine,
    color: "text-gold",
    bg: "bg-gold/10",
  },
  {
    time: "7:00 PM",
    title: "Gala Dinner",
    description: "A sumptuous 3-course dinner with curated wines at Golden Garden Rebero.",
  ...
  },
  {
    time: "9:30 PM",
    title: "Evening Dance",
    description: "Dance the night away to live music and your favorite hits from the DJ.",
    icon: Music,
    color: "text-gold",
    bg: "bg-gold/10",
  },
